...
# Cortex and drop it into the destination folder.
#
# Usage (from WSL):
#   scripts/build-portable.sh
#
# Output:
#   ${DEST_DIR:-$PWD}/cortex-portable-<version>.zip
#   (set DEST_DIR to override; defaults to the current directory)
#
# Contents of the zip:
...
# Destination: $DEST_DIR if set, else the current working directory.
