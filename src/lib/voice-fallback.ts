 ...
 *
 * Wired into the composer's mic button (`MicCaptureButton` in
 * ComposerPanel.tsx), which records a clip and inserts the transcript at
 * the cursor via `cortex:composer-insert`.
 */
