...
/** Login fallback: open a webview at the provider's web app; after sign-in the
 *  session cookie is read from the webview and persisted. Resolves once a
 *  session is captured (or rejects on timeout/cancel). */
