...
/** Encode an absolute project root into its `~/.claude/projects/…` directory
 *  name, matching Claude Code: every separator (incl. the Windows drive colon)
 *  becomes '-'. "/home/x" → "-home-x"; "C:\\Users\\x" → "C--Users-x". */
