...
function labelFor(tab: NonNullable<ReturnType<typeof useCortexStore.getState>["activityTab"]>): string {
  switch (tab) {
    ...
    case "focus": return "Focus chain";
    case "trust": return "Trust matrix";
    case "skills": return "Skills";
    case "prp": return "PRPs";
    case "terminal": return "Terminal";
    case "git": return "Git history";
    case "source-control": return "Source control";
    case "editor": return "Editor";
    case "preview": return "Web preview";
    case "orchestrator": return "Orchestrator";
    case "ultimate": return "Ultimate agent";
    case "tools": return "Tools registry";
    case "snippets": return "Snippets";
    case "workflows": return "Workflows";
    case "help": return "Help";
    case "search": return "Search";
    case "gateway": return "Cortex Gateway capabilities";
    case "knowledge-graph": return "Knowledge graph";
    case "dep-graph": return "Dependency graph";
    case "metrics": return "Project metrics";
    case "bookmarks": return "Bookmarks";
    case "arena": return "Model arena";
    case "channels": return "Channels";
    case "multibuffer": return "Multibuffer";
    case "lanes": return "Lanes";
    case "cookbook": return "Local-Model Cookbook";
    case "research": return "Deep Research";
    case "routines": return "Scheduled routines";
    case "eval": return "Agent eval";
