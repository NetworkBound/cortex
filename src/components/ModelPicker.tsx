...
export function ModelPicker() {
  ...
  // If an override is active but the model isn't in the discovered list (not yet
  // loaded, pulled away, or a stale persisted value), surface it as a synthetic
  // option so the <select> reflects the real active model instead of showing
  // "Auto".
