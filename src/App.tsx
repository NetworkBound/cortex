...
export function App() {
  ...
  }, [currentMode, setCurrentMode, statusBarCompact, setStatusBarCompact, setShowSessionPicker, setActivityTab]);
    ...
    <div className="cortex-shell">
      ...
      <div className={`cortex-grid ${archOpen || (activityTab && activityTab !== "projects") ? "with-activity-panel" : ""}`}>
        ...
        <div className="cortex-col-right">
          ...
          {/* Right rail holds only the ambient surfaces that DON'T have an
              activity-bar home. Memory and Brain were duplicated here and in
              the activity bar; they now live solely in the activity bar (open
              via the rail or Ctrl+K / Ctrl+Shift+F for Memory). */}
