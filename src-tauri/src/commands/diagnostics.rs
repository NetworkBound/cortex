...
mod tests {
    ...
    fn bundle_never_contains_secrets_ips_or_usernames() {
        let crashes = r#"[{"message": "panic: bad key sk-ant-api03-LeakedKeyAbCdEfGh99 at http://10.0.0.10:8642", "stack": "/home/exampleuser/x.rs:1"}]"#;
        let sessions = r#"[{"session_id": "s1", "project_root": "/home/exampleuser/projects/cortex"}]"#;
        let cfg_files = vec![(
            "git-config.json".to_string(),
            r#"{"git_server_url": "http://10.0.0.20:3000", "token": "ghp_0123456789abcdefghijABCDEFG"}"#.to_string(),
        )];
